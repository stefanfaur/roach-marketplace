...
description: Use when validating that an implementation plan was correctly executed, verifying success criteria, and identifying deviations or issues
---
...
validate-plans thoughts/shared/plans/domain/plan.md file1.java file2.java
```
...
1. `implementing-plans` - Execute the implementation
2. `validating-plans` - Verify implementation correctness (provide changed files)
3. `committing` - Create atomic commits for verified changes
