...
- roach/skills/initializing-codebase-index/SKILL.md — one-time deep bootstrap of codebase index (replaced former command)
...
- roach/skills/create-handoff/SKILL.md         — context preservation for session continuity
- roach/skills/committing/SKILL.md             — structured git commit workflow
- roach/skills/writing-natural/SKILL.md        — prose quality guidance for docs and READMEs
...
- To see index-aware skills → roach/skills/using-codebase-index/, roach/skills/update-codebase-index/, roach/skills/initializing-codebase-index/
- Full skill list (20 skills) → roach/skills/*/SKILL.md
