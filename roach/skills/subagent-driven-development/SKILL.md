...
digraph process {
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Announce completion and ask user how to proceed";
}
```
...
- **create_plan** - Creates the plan this skill executes
- **implement_plan** - starts the implementation process, triggers subagent-driven development
