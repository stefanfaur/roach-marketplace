...
Not a certified STE checker. Scores violations per 100 words; the delta between
two drafts is the signal, not the absolute value.

Adapted from https://github.com/woosal1337/blog (MIT, Copyright (c) 2026 Ege Celebi).
"""
