...
1. **Create Failing Test Case**
   ...
   - Use the `roach:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **roach:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **roach:verification-before-completion** - Verify fix worked before claiming success
